      ...
      <v-card style="width: 1000px">
        <v-container>
          <v-row>
            ...
            <v-col cols="6">
              <h1 style="text-align: center">ເພີ່ມຂໍ້ມູນໂຮງໝໍ</h1>
...
export default {
  ...
  methods: {
    ...
    save() {
      console.log('HOSTPITAL', this.create.hospital_name)
      console.log('HOSTPITAL', this.create.tel)
      console.log('address', this.create.address_detail)
      console.log('villageId', this.villageId)
      console.log('lat', this.create.lat)
      console.log('lng', this.create.lng)
      if (
    ...
    async saveData() {
      ...
      try {
        ...
        console.log(config)
        await axios.post('/hospital/create', formData, config)
